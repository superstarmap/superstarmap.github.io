...
Map {
  background-image: url("img/superstar/rajni7.jpg");
}

// Mapbox Terrain global landcover //

#landcover {
  [class='wood'] { polygon-pattern-file: url("img/superstar/rajni9.jpg");polygon-pattern-alignment: local; }
  [class='scrub'] { polygon-pattern-file: url("img/superstar/rajni11.jpg"); }
  [class='grass'] { polygon-pattern-file: url("img/superstar/rajni4.jpg"); }
  [class='crop'] { polygon-pattern-file: url("img/superstar/rajni6.jpg"); }
...
#landuse {
  ...
  ::cover[zoom>=15] {
    ...
    [class='wood'] { polygon-pattern-file: url("img/superstar/rajni14.jpg"); }
...
#water {
  polygon-pattern-file: url("img/superstar/rajni12.jpg");
